...
const Navbar = ({ onLogout }) => {
  ...
  // ✅ Safe values so we never access properties on null
  const displayName =
    adminUser?.username ||
    adminUser?.name ||
    adminUser?.email ||
  ...
  const displayRole = adminUser?.role || 'Administrator';
    ...
    <nav className="navbar">
      ...
      <div className="navbar-user">
        ...
        >
          ...
          {/* ✅ Use safe displayName so it never crashes */}
