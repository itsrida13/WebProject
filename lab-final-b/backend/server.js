...
app.use("/order", orderRoutes); // ✅ Customer order routes
...
const startServer = async () => {
  try {
    ...
    app.listen(PORT, () => {
      ...
      console.log(`📦 Orders: http://localhost:${PORT}/order/preview`);
      console.log(`📋 My Orders: http://localhost:${PORT}/order/my-orders`);
    });
  } catch (err) {
